...
$checks = "SELECT* FROM users WHERE mobile_number='$mnum' LIMIT 1";
$contacts2 =mysqli_query($conn, $checks);
$packs =mysqli_fetch_row($contacts2);
...
<head> 
	...
	<body>
		...
		<footer class="mainFooter">
			<p>Copyright &copy:2016 <a href ="#" title= "friendslink">friendslink.com</a></P>
		</footer>
